...
<body>
	...
	<form method="post" action="/SimpleWarehousManagementSystem/inbound-outbound/update-outbound">
		<input type="hidden" name="action" value="outbound" />
		<table>
			<tr><td><input type='hidden' name='action' value='inbound'></td></tr>
			<tr><td>Rack ID</td><td><input type = "text" id="rackId" name="rackId" readonly="readonly" value="<%= request.getParameter("rack-id") %>" /></td><td><input type="button" id="showRackId" value="..."/></td></tr>
			<tr><td>Item ID</td><td><input type = "text" id="itemId" name="itemId" readonly="readonly" value="<%= request.getParameter("item-id") %>"/></td><td><input type="button" id="showItemId" value="..."/><input type="button" id="addItem" value="+"/></td></tr>
