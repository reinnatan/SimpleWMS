    ...
    <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
            <li><a class="dropdown-item" href="/SimpleWarehousManagementSystem/add-warehouse">Add Racks</a></li>
             <li><a class="dropdown-item" href="/SimpleWarehousManagementSystem/list-warehouse">List Racks</a></li>
          </ul>
        </li>
